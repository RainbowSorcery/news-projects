...
public enum ResponseStatusEnum {
    ...
    USERNAME_NOTFOUND(605, false, "用户名不能为空"),

    // 上传
    UPLOAD_SUCCESS(210, true, "上传文件成功！"),
    UPLOAD_FAILED(558, false, "上传文件失败"),
    GET_FILE_IMAGE_URL_FAILED(559, false, "获取文件路径失败"),
    UPLOAD_IMAGE_BASE64_ISNULL(560, false, "图片上传文件base64为空"),
